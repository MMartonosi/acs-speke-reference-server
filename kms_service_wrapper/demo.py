...
sys.path.append(
    os.path.abspath(
        os.path.join(os.path.abspath(__file__), "..", "..", "config")
    )
)

from kms.wrapper import (
    acs_kms_generate_data_key,
    acs_kms_decrypt_cipher_key
)

from oss.wrapper import (
    acs_oss_create_key,
    acs_oss_get_key
)

RHB_UUIDs = ["948e65c0-55b6-4ca3-9d5c-feb8e3dc2a3a",
